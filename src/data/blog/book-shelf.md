---
title: 'Book Shelf'
pubDate: 2026-05-15 18:00
description: 'A new /shelf page pulling reading data from Hardcover via their GraphQL API'
...
image:
  ...
  source: "https://www.teebooks.eu/bookshelves/275-wall-bookshelf-60-x-15-cm-set-of-6.html"
---
...
So, I've added a [/shelf](/shelf) page to the site. It pulls my reading data from [Hardcover](https://hardcover.app), a book tracking service that seems like a decent alternative to Goodreads (which no longer provides an API for this kinda thing). 
