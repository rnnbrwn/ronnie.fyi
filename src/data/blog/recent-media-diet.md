...
tags: ['media', 'taskmaster', 'cardiacs', 'rangers fc']
---

Some media I've consumed recently:

- [Hitler: The Rise of Evil](https://en.wikipedia.org/wiki/Hitler:_The_Rise_of_Evil) (Part 2), continuing the recent deep-dive into the WW2-universe
- [Race](<https://en.wikipedia.org/wiki/Race_(2016_film)>), see above
- [Taskmaster](<https://en.wikipedia.org/wiki/Taskmaster_(TV_series)>), seasons 1 to 4, rewatching since my daughter is newly obsessed with the show
- [LSD by Cardiacs](<https://en.wikipedia.org/wiki/LSD_(Cardiacs_album)>)
