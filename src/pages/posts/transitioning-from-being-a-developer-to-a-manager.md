...
I'd initially thought this was written by **Andy Bell**, head honcho at [Piccalilli](https://piccalil.li/) (where the article is hosted), but it was written by **Liam Egan**, whose work I wasn't familiar with. His piece on [Transitioning From Being a Developer to a Manager](https://piccalil.li/blog/transitioning-from-being-a-developer-to-a-manager/) would've been incredibly helpful if I'd been able to read it 20 years ago.
...
Incidentally, Liam is Director of Technology for [We the Collective](https://www.wethecollective.com/), and they have a lovely site.
